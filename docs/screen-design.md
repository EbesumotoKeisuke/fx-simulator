...
+-------------------------------------------------------------------------------------------+
| 注文パネル                                                                    [▼展開]    |
| | 注文タイプ: ●成行 ○指値 ○逆指値  |  価格: [145.50]  |  SL: [☑ 144.50]  TP: [☑ 146.50] |
+-------------------------------------------------------------------------------------------+
...
| コントロールバー | 50px | 再生コントロール + 簡易注文（1行に統合） |
| 注文パネル | 40px | 詳細注文設定（成行・指値・逆指値、SL/TP） |
...
| Entry | エントリー価格 |
| 現在 | 現在のシミュレーション価格 |
| SL | 損切り価格またはpips（例: 145.500 または -20p）、設定なしは「-」 |
